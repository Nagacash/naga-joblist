...
import { calculateCompletion, normalizeEducation } from "@/lib/profile-utils";
...
export default async function ProfilePage() {
  ...
  return (
    <>
      ...
      <main className="app-ambient mx-auto flex min-h-[calc(100vh-4rem)] max-w-[1440px] flex-col gap-6 px-4 py-8 sm:px-6 lg:px-8">
