...
export function LoginCard({ error, callback }: Props) {
  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-[1440px] items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="glass-panel grid w-full max-w-5xl overflow-hidden rounded-[24px] lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="flex flex-col justify-center p-8 sm:p-10">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-semibold leading-9 text-text-primary">
              Naga Codex
              <span className="ml-2 align-middle text-sm font-semibold uppercase tracking-[0.22em] text-accent">
                Job Pilot
              </span>
            </h2>
