...
@theme {
  ...
  /* Primary accent — NAGA gold (paired with dark ink) */
  --color-accent: #a67c00;
  --color-accent-dark: #856200;
  --color-accent-light: #f7efd6;
  --color-accent-muted: #fbf7ec;
...
|---|---|---|
| Resume tailored | `#F7EFD6` (accent-light) | `#A67C00` (accent) |
...
| Chart                            | Color                                                           |
| -------------------------------- | --------------------------------------------------------------- |
| Jobs Found Over Time (line)      | `#A67C00` stroke, 3px width, gradient fill rgba(166,124,0,0.2) |
...
```
asset: /images/logo.png (NAGA gold/black cobra emblem)
border-radius: 8px (rounded-lg)
size: 36x36px
wordmark: "JobPilot" — 19px / 700 / text-text-darkest, next to emblem
```
...
- `--accent` (#A67C00, NAGA gold) is the only accent — never use Tailwind's built-in color scales
